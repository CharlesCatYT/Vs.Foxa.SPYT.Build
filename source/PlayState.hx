...
class PlayState extends MusicBeatState
{
		...
		for (i in SONG.eventObjects)
		{
			switch (i.type)
			{
				...
				case "Character Change":
					...
					{
                     changeDadChar(sucharacter);
					}
				case "Hey!":
					boyfriend.playAnim('hey', true);
					boyfriend.specialAnim = true;
					boyfriend.heyTimer = time;
				case "Play BF Dodge Animation":
						//trace('Anim to play: ' + value1)
							boyfriend.playAnim('dodge', true);
							boyfriend.specialAnim = true;
				case "Play BF Hurt Animation":
					    //trace('Anim to play: ' + value1)
	...
	public function changeDadChar(sucharacter:String)
		{
			remove(dad);
			dad = new Character(100, 100, sucharacter);
			trace("Character Change!");
			add(dad);
		}

	var sucharacter:String;
}
