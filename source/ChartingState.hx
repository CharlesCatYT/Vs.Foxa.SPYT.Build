...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addEventsUI()
	{
		...
		var eventType = new FlxUIDropDownMenu(10, 60, FlxUIDropDownMenu.makeStrIdLabelArray(["BPM Change", "Scroll Speed Change", "Character Change", "Hey!", 
		"Play BF Dodge Animation", "Play BF Hurt Animation", "Camera Zoom"], true));
