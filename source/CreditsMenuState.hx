...
//i took it from vdab but i'll wait for t5mpler to respond
class CreditsMenuState extends MusicBeatState
{
	...
	var peopleInCredits:Array<Person> = [
		...
		// contributors
		new Person("Ben", CreditsType.Contributor, "Music Player Code", []),
      new Person("T5mpler", CreditsType.Contributor, "Credits Menu Code", []),
		// testers
		new Person("MarioYoshi7", CreditsType.BetaTester, "Beta Tester", [new Social('gamejolt', 'https://gamejolt.com/@MarioYoshi7'),]),
	];
	...
	override function create()
	{
		...
		for (i in 0...peopleInCredits.length)
		{
			...
			textItem.setFormat("PhantomMuff 1.5", defaultFormat.size, defaultFormat.color, defaultFormat.alignment, defaultFormat.borderStyle,
